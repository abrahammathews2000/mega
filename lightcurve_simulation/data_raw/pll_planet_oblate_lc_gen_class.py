...
class LcGenerator:
    def __init__(self, shape_dir, LD_Coeff,save_lc_folder_name,shape_name,star2mega_radius_ratio=4):
    ...
    def save_lc(self,lc,time,name):
        ...
        np.savetxt(str(self.folder_name)+ str(self.shape_name) +'_lc_'+ str(self.LD_Coeff[0])+'_'+str(self.LD_Coeff[1])+ ".csv", lc, delimiter=',')
