...
# Change this everytime you run - contain the shapes, c
# - change batch index in (IMP: batch_pll_lc_curve_generator)
index_shapefolder = 5
#
...
y_dir = '/home/abraham/Documents/ms_proj_shape_lc_gen/data_npy/shape_npy/shape_filled' + str(index_shapefolder) +'_batches/'# shape_filled.npy
